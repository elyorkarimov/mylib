...
class ExportBookFileType implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($bookstype): array
    {
        return [
            ...
            \App\Models\BookFileType::GetCountBookByBookTypeId($bookstype->id),
            \App\Models\BookFileType::GetCountBookCopiesByBookTypeId($bookstype->id)
        ];
    }
    /**
     * @return \Illuminate\Support\Collection
