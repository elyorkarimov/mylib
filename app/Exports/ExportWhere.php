...
class ExportWhere implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($bookstype): array
    {
        return [
            ...
            \App\Models\Where::GetCountBookByBookTypeId($bookstype->id),
            \App\Models\Where::GetCountBookCopiesByBookTypeId($bookstype->id)
        ];
    }
    /**
     * @return \Illuminate\Support\Collection
