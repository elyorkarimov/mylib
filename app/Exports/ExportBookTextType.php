...
class ExportBookTextType implements FromCollection, WithMapping, WithHeadings
{
    use Exportable;
    ...
    public function map($bookstype): array
    {
        return [
            ...
            \App\Models\BookTextType::GetCountBookByBookTypeId($bookstype->id),
            \App\Models\BookTextType::GetCountBookCopiesByBookTypeId($bookstype->id)
        ];
    }
    /**
     * @return \Illuminate\Support\Collection
