 ...
 * @property $updated_at
 *
 * @property BasicTranslation[] $basicTranslations
 ...
 */
class Basic extends Model implements TranslatableContract
{
     ...
     */
    public function basicTranslations()
    {
        return $this->hasMany('App\Models\BasicTranslation', 'basic_id', 'id');
    }
