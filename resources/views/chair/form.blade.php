        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    ...
                    @if ($chair != null)
                        <livewire:admin.references.org-branch-faculty :org_id="$chair->organization_id" :branch_id="$chair->branch_id" :faculty_id="$chair->faculty_id" />
                    @else
                        <livewire:admin.references.org-branch-faculty :org_id="null" :branch_id="null" :faculty_id="null" />
                    @endif
