                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                    if (count($faculty->facultyTranslations) > 0 && isset($faculty->facultyTranslations[$step]) &&  $faculty->facultyTranslations[$step]->locale == $k) {
                                                        $title = $faculty->facultyTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    @php
                        $isActive = 1;
                        if ($faculty->count() > 0 && isset($faculty->isActive)) {
                    ...
                    @if ($faculty != null)
                        <livewire:admin.references.org-branch :org_id="$faculty->organization_id" :branch_id="$faculty->branch_id" />
                    @else
                        <livewire:admin.references.org-branch :org_id="null" :branch_id="null" />
                    @endif
