...
<div class="content">
    ...
    <div class="breadcrumb-wrapper breadcrumb-contacts">
        ...
        <div>
            <a href="{{ url(app()->getLocale() . '/admin/resource-types') }}"  class="btn btn-primary" >{{ __('Back') }}</a>
        </div>
    </div>

    @includeif('partials.errors')
    <form method="POST" action="{{ route('resource-types.update', [app()->getLocale(), $resourceType->id]) }}"  role="form" enctype="multipart/form-data">
        {{ method_field('PATCH') }}
        @csrf
