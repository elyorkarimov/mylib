                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($resourceType->resourceTypeTranslations) > 0 && isset($resourceType->resourceTypeTranslations[$step]) && $resourceType->resourceTypeTranslations[$step]->locale == $k) {
                                                        $title = $resourceType->resourceTypeTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
            ...
            <div class="card-body">
                <div class="ec-cat-form">
                    <div class="form-group row">
                        {{ Form::label('Code') }}
                        {{ Form::text('code', $resourceType->code, ['class' => 'form-control' . ($errors->has('code') ? ' is-invalid' : ''), 'placeholder' => 'Code']) }}
                        {!! $errors->first('code', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    @php
                        $isActive = 1;
                        if ($resourceType->count() > 0 && isset($resourceType->isActive)){
                    ...
                    <div class="form-group">
                        {{ Form::hidden('key', "type",  ['class' => 'form-control' . ($errors->has('key') ? ' is-invalid' : ''), 'placeholder' => 'Key', 'value' => 'type']) }}
