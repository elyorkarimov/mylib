                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                    if (count($department->departmentTranslations) > 0 && isset($department->departmentTranslations[$step]) && $department->departmentTranslations[$step]->locale == $k) {
                                                        $title = $department->departmentTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    ...
                    @if ($department != null)
                        <livewire:admin.references.org-branch :org_id="$department->organization_id" :branch_id="$department->branch_id" />
                    @else
