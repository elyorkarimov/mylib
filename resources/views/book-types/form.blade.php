                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($booksType->booksTypeTranslations) > 0 && isset($booksType->booksTypeTranslations[$step]) && $booksType->booksTypeTranslations[$step]->locale == $k) {
                                                        $title = $booksType->booksTypeTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
                ...
                <div class="ec-cat-form">
                    ...
                    <div class="form-group">
                        ...
                        @if ($booksType->image_path)
                            <img src="{{ asset('/storage/booksTypes/photo/' . $booksType->image_path) }}" width="100px">
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('icon_path', $booksType->icon_path, ['class' => 'form-control' . ($errors->has('icon_path') ? ' is-invalid' : ''), 'placeholder' => __('Icon Path')]) }}
                        {!! $errors->first('icon_path', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
