...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pdf-view/pdfjs/viewer.css')}}"/>
    <link rel="stylesheet" href="{{ asset('pdf-view/pdf-flip.css')}}"/>
    ...
    <style>
        .se-pre-con {
            ...
            height: 100%;
            z-index: 9999;
            background: url(/pdf-view/pics/loader.gif) center no-repeat #fff;
        }
    </style>
</head>
...
<input type="hidden" name="file" id="book_file" value="/storage/{{$book->full_text_path}}">
...
<script src="{{ asset('pdf-view/pdfjs/build/pdf.js')}}"></script>
<script src="{{ asset('pdf-view/pdfjs/debugger.js')}}"></script>
<script src="{{ asset('pdf-view/pdfjs/viewer.js')}}"></script>
<script src="{{ asset('pdf-view/pdf-flip.js?v=1.1.1.1.1.1')}}"></script>
