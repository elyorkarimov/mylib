                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($bookLanguage->bookLanguageTranslations) > 0 && isset($bookLanguage->bookLanguageTranslations[$step]) && $bookLanguage->bookLanguageTranslations[$step]->locale == $k) {
                                                        $title = $bookLanguage->bookLanguageTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    @php
                        $isActive = 1;
                        if ($bookLanguage->count() > 0 && isset($bookLanguage->isActive)){
                    ...
                    <div class="form-group row">
                        {{ Form::label('Code') }}
                        {{ Form::text('code', $bookLanguage->code, ['class' => 'form-control' . ($errors->has('code') ? ' is-invalid' : ''), 'placeholder' => 'Code']) }}
