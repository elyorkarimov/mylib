                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($genType->genTypeTranslations) > 0 && isset($genType->genTypeTranslations[$step]) && $genType->genTypeTranslations[$step]->locale == $k) {
                                                        $title = $genType->genTypeTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    @php
                        $isActive = 1;
                        if ($genType->count() > 0 && isset($genType->isActive)){
                            $isActive = $genType->isActive;
                        }
                    ...
                    <div class="form-group">
                        {{ Form::label(__('Key')) }}
                        {{ Form::text('code', $genType->code, ['class' => 'form-control' . ($errors->has('code') ? ' is-invalid' : ''), 'placeholder' => __('Key')]) }}
