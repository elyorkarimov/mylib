                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($publisher->publisherTranslations) > 0 && isset($publisher->publisherTranslations[$step]) && $publisher->publisherTranslations[$step]->locale == $k) {
                                                        $title = $publisher->publisherTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    @php
                        $isActive = 1;
                        if ($publisher->count() > 0 && isset($publisher->isActive)){
