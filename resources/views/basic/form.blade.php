                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $title = null;
                                                     if (count($basic->basicTranslations) > 0 && isset($basic->basicTranslations[$step]) && $basic->basicTranslations[$step]->locale == $k) {
                                                        $title = $basic->basicTranslations[$step]->title;
                                                    }
                                                    $step++;
                                                @endphp
        ...
        <div class="ec-cat-list card card-default mb-24px">
            <div class="card-body">
                <div class="ec-cat-form">
                    @php
                        $isActive = 1;
                        if ($basic->count() > 0 && isset($basic->isActive)){
