...
<div class="content">
    ...
    <form method="POST" action="{{ route('scientific-publication-translations.update', [app()->getLocale(), $scientificPublicationTranslation->id]) }}"  role="form" enctype="multipart/form-data">
        {{ method_field('PATCH') }}
        @csrf
