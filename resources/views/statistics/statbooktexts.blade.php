...
@section('content')
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                <h1>{{ __('Monthly statistics on book texts of literature') }}</h1>
            ...
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    ...
                    <div class="card-header">
                        <form action="{{ route('admin.statbooktexts', app()->getLocale()) }}" method="GET"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('admin.statbooktexts', app()->getLocale()) }}"
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($months as $k => $month)
                                                <td>
                                                    ...
                                                    <b>{!! \App\Models\BookText::GetCountBookByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b> <br>
                                                    <b>{!! \App\Models\BookText::GetCountBookCopiesByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b>
                                                </td>
                                            @endforeach
                                        </tr>
                                    @endforeach
