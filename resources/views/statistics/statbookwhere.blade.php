            ...
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    ...
                    <div class="card-header">
                        <form action="{{ route('admin.statbookwhere', app()->getLocale()) }}" method="GET"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('admin.statbookwhere', app()->getLocale()) }}"
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($months as $k => $month)
                                                <td>
                                                    ...
                                                    <b>{!! \App\Models\Where::GetCountBookByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b> <br>
                                                    <b>{!! \App\Models\Where::GetCountBookCopiesByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b>
                                                </td>
                                            @endforeach
                                        </tr>
                                    @endforeach
