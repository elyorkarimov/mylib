...
@section('content')
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                <h1>{{ __('Monthly statistics on who of literature') }}</h1>
            ...
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    ...
                    <div class="card-header">
                        <form action="{{ route('admin.statbookwhos', app()->getLocale()) }}" method="GET"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('admin.statbookwhos', app()->getLocale()) }}"
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($months as $k => $month)
                                                <td>
                                                    ...
                                                    <b>{!! \App\Models\Who::GetCountBookByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b> <br>
                                                    <b>{!! \App\Models\Who::GetCountBookCopiesByBookTypeByMonthAndId($booksType->id, $year, $k)!!}</b>
                                                </td>
                                            @endforeach
                                        </tr>
                                    @endforeach
