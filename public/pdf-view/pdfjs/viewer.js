...
'use strict';
var full_path = document.getElementById('book_file').value;
console.log();
// var DEFAULT_URL =  "/pdf-view/compressed.tracemonkey-pldi-09.pdf";
var DEFAULT_URL =  full_path;
...
PDFJS.imageResourcesPath = '/pdf-view/images/';
PDFJS.workerSrc = '/pdf-view/pdfjs/build/pdf.worker.js';
PDFJS.cMapUrl = '/pdf-view/pdfjs/cmaps/';
